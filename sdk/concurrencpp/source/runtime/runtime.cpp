...
concurrencpp::thread_pool_executor* runtime::thread_pool_executor_raw() const noexcept {
    return m_thread_pool_executor.get();
}

concurrencpp::thread_pool_executor* runtime::background_executor_raw() const noexcept {
    return m_background_executor.get();
}
